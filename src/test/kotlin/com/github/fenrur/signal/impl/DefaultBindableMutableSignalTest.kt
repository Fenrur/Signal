...
/**
 * Tests for DefaultBindableMutableSignal.
 * Extends AbstractMutableSignalTest (for MutableSignal interface compliance).
 * Uses nested class for AbstractBindableSignalTest (for bindable-specific behavior).
 */
class DefaultBindableMutableSignalTest : AbstractMutableSignalTest() {
    ...
    class BindableBehaviorTests : AbstractBindableSignalTest<BindableMutableSignal<Int>>() {
        ...
        override fun createSignal(source: Signal<Int>): BindableMutableSignal<Int> {
            // BindableMutableSignal requires MutableSignal source
        ...
        override fun wouldCreateCycle(signal: BindableMutableSignal<Int>, target: Signal<Int>): Boolean =
            // Use BindableSignal.wouldCreateCycle which accepts Signal<T> as target
