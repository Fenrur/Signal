...
class ResourceCleanupTest {
    ...
    fun `computed signal does not subscribe until needed`() {
        ...
        val source = object : io.github.fenrur.signal.Signal<Int> {
            override val value: Int = 10
            override val isClosed: Boolean = false
            override fun subscribe(listener: io.github.fenrur.signal.SubscribeListener<Int>): io.github.fenrur.signal.UnSubscriber {
                subscribeCount++
