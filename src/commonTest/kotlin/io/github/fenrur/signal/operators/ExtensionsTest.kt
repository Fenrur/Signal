...
class ExtensionsTest {
    ...
    fun `mapToString works with complex objects`() {
        ...
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(Person("John"))
        val mapped = source.mapToString()
    ...
    fun `bimap reads with forward transform`() {
        val source = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf("42")
    ...
    fun `flatten flattens nested signals`() {
        ...
        val outer =
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(inner1 as io.github.fenrur.signal.Signal<Int>)
    ...
    fun `flatten updates when inner signal changes`() {
        ...
        val outer =
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(inner as io.github.fenrur.signal.Signal<Int>)
        val flattened = outer.flatten()
    ...
    fun `flatMap maps and flattens`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(1)
        val flattened = source.flatMap { _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(it * 10) }
    ...
    fun `switchMap is alias for flatMap`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(1)
        val switched = source.switchMap { _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(it * 10) }
    ...
    fun `filterIsInstance filters by type`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal<Any>("hello")
    ...
    fun `combine2 combines two signals`() {
        ...
        val combined = _root_ide_package_.io.github.fenrur.signal.operators.combine(a, b) { x, y -> x + y }
    ...
    fun `combine3 combines three signals`() {
        ...
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2)
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3)
    ...
    fun `combine4 combines four signals`() {
        ...
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2)
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3)
        val d = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4)
        val combined =
            _root_ide_package_.io.github.fenrur.signal.operators.combine(a, b, c, d) { w, x, y, z -> w + x + y + z }
    ...
    fun `combine5 combines five signals`() {
        ...
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3)
        val d = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4)
        val e = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5)
        val combined = _root_ide_package_.io.github.fenrur.signal.operators.combine(
            a,
            b,
            c,
            d,
    ...
    fun `combine6 combines six signals`() {
        ...
        val d = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4)
        val e = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5)
        val f = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(6)
        val combined = _root_ide_package_.io.github.fenrur.signal.operators.combine(
            a,
            b,
            c,
    ...
    fun `zip combines two signals into pair`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("hello")
        val zipped = _root_ide_package_.io.github.fenrur.signal.operators.zip(a, b)
    ...
    fun `zip3 combines three signals into triple`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(1)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("two")
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3.0)
        val zipped = _root_ide_package_.io.github.fenrur.signal.operators.zip(a, b, c)
    ...
    fun `zip4 combines four signals into Tuple4`() {
        ...
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("two")
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3.0)
        val d = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val zipped = _root_ide_package_.io.github.fenrur.signal.operators.zip(a, b, c, d)

        assertEquals(_root_ide_package_.io.github.fenrur.signal.operators.Tuple4(1, "two", 3.0, true), zipped.value)
    }
    ...
    fun `zip5 combines five signals into Tuple5`() {
        ...
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3.0)
        val d = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val e = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal('x')
        val zipped = _root_ide_package_.io.github.fenrur.signal.operators.zip(a, b, c, d, e)

        assertEquals(_root_ide_package_.io.github.fenrur.signal.operators.Tuple5(1, "two", 3.0, true, 'x'), zipped.value)
    }
    ...
    fun `zip6 combines six signals into Tuple6`() {
        ...
        val d = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val e = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal('x')
        val f = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(100L)
        val zipped = _root_ide_package_.io.github.fenrur.signal.operators.zip(a, b, c, d, e, f)

        assertEquals(_root_ide_package_.io.github.fenrur.signal.operators.Tuple6(1, "two", 3.0, true, 'x', 100L), zipped.value)
    }
    ...
    fun `combineAll combines multiple signals into list`() {
        ...
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2)
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3)
        val combined = _root_ide_package_.io.github.fenrur.signal.operators.combineAll(a, b, c)
    ...
    fun `combineAll with empty returns empty list`() {
        val combined = _root_ide_package_.io.github.fenrur.signal.operators.combineAll<Int>()
    ...
    fun `combineAll updates when any signal changes`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(1)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2)
        val combined = _root_ide_package_.io.github.fenrur.signal.operators.combineAll(a, b)
    ...
    fun `list combineAll extension`() {
        val signals = listOf(
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(1),
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2),
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3)
        )
    ...
    fun `not negates boolean signal`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
    ...
    fun `and combines two boolean signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val result = a.and(b)
    ...
    fun `or combines two boolean signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val result = a.or(b)
    ...
    fun `allOf returns true if all signals are true`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(true)
        val result = _root_ide_package_.io.github.fenrur.signal.operators.allOf(a, b, c)
    ...
    fun `anyOf returns true if any signal is true`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val c = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val result = _root_ide_package_.io.github.fenrur.signal.operators.anyOf(a, b, c)
    ...
    fun `noneOf returns true if no signal is true`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(false)
        val result = _root_ide_package_.io.github.fenrur.signal.operators.noneOf(a, b)
    ...
    fun `plus Long adds two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(20L)
        val result = a + b
    ...
    fun `plus Double adds two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.5)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(20.5)
        val result = a + b
    ...
    fun `plus Float adds two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.5f)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(20.5f)
        val result = a + b
    ...
    fun `minus Int subtracts two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(30)
    ...
    fun `minus Long subtracts two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(30L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10L)
        val result = a - b
    ...
    fun `minus Double subtracts two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(30.5)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.5)
        val result = a - b
    ...
    fun `minus Float subtracts two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(30.5f)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.5f)
        val result = a - b
    ...
    fun `times Int multiplies two signals`() {
        ...
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4)
        val result = a * b
    ...
    fun `times Long multiplies two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4L)
        val result = a * b
    ...
    fun `times Double multiplies two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2.5)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4.0)
        val result = a * b
    ...
    fun `times Float multiplies two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2.5f)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4.0f)
        val result = a * b
    ...
    fun `div Int divides two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(20)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4)
        val result = a / b
    ...
    fun `div Long divides two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(20L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4L)
        val result = a / b
    ...
    fun `div Double divides two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.0)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4.0)
        val result = a / b
    ...
    fun `div Float divides two signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.0f)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(4.0f)
        val result = a / b
    ...
    fun `rem Long computes remainder`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3L)
        val result = a % b
    ...
    fun `coerceIn Int clamps value to range`() {
        val value = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(15)
        val min = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(0)
        val max = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10)
    ...
    fun `coerceIn Long clamps value to range`() {
        val value = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(15L)
        val min = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(0L)
        val max = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10L)
        val result = value.coerceIn(min, max)
    ...
    fun `coerceIn Double clamps value to range`() {
        val value = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(15.0)
        val min = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(0.0)
        val max = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.0)
        val result = value.coerceIn(min, max)
    ...
    fun `coerceAtLeast Int with signal`() {
        val value = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5)
        val min = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10)
    ...
    fun `coerceAtLeast Long with signal`() {
        val value = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5L)
        val min = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10L)
        val result = value.coerceAtLeast(min)
    ...
    fun `coerceAtLeast Double with signal`() {
        val value = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5.0)
        val min = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.0)
        val result = value.coerceAtLeast(min)
    ...
    fun `gt Int compares signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5)
        val result = a gt b
    ...
    fun `gt Long compares signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5L)
        val result = a gt b
    ...
    fun `gt Double compares signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10.0)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5.0)
        val result = a gt b
    ...
    fun `lt Int compares signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5)
        val result = a lt b
    ...
    fun `lt Long compares signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3L)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5L)
        val result = a lt b
    ...
    fun `lt Double compares signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(3.0)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(5.0)
        val result = a lt b
    ...
    fun `eq works with strings`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("hello")
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("hello")
        val result = a eq b
    ...
    fun `plus String concatenates signals`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("Hello")
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(" World")
        val result = a + b
    ...
    fun `isEmpty String returns true for empty`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("")
    ...
    fun `size returns list size`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(1, 2, 3))
    ...
    fun `isEmpty List returns true for empty list`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(emptyList<Int>())
        val result = source.isEmpty()
    ...
    fun `isNotEmpty List returns true for non-empty list`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(1, 2))
        val result = source.isNotEmpty()
    ...
    fun `getOrNull returns element at index`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(10, 20, 30))
    ...
    fun `getOrNull returns null for out of bounds`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(10, 20))
    ...
    fun `getOrNull with signal index`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(10, 20, 30))
        val index = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2)
    ...
    fun `contains with signal element`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(1, 2, 3))
        val element = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(2)
    ...
    fun `filterList filters list elements`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(1, 2, 3, 4, 5))
    ...
    fun `sorted sorts list ascending`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(3, 1, 4, 1, 5))
    ...
    fun `distinct removes duplicates`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(listOf(1, 2, 2, 3, 1))
    ...
    fun `orDefault with signal provides default`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal<Int?>(null)
        val default = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(42)
    ...
    fun `orElse is alias for orDefault`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal<Int?>(null)
        val fallback = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(42)
    ...
    fun `toggle flips boolean`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(false)
    ...
    fun `increment Int increases value`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(10)
    ...
    fun `increment Long increases value`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(10L)
    ...
    fun `increment Double increases value`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(10.0)
    ...
    fun `append adds suffix to string`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf("Hello")
    ...
    fun `prepend adds prefix to string`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf("World")
    ...
    fun `add appends to list`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(listOf(1, 2))
    ...
    fun `addAll appends multiple to list`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(listOf(1))
    ...
    fun `remove removes from list`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(listOf(1, 2, 3))
    ...
    fun `removeAt removes element at index`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(listOf(10, 20, 30))
    ...
    fun `add appends to set`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(setOf(1, 2))
    ...
    fun `remove removes from set`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(setOf(1, 2, 3))
    ...
    fun `put adds entry to map`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(mapOf("a" to 1))
    ...
    fun `remove removes key from map`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.mutableSignalOf(mapOf("a" to 1, "b" to 2))
    ...
    fun `combine and map can be chained`() {
        val a = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(10)
        val b = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(20)
        val result = _root_ide_package_.io.github.fenrur.signal.operators.combine(a, b) { x, y -> x + y }
            .map { it * 2 }
            .mapToString()
