...
class CombinedSignalsTest {
    ...
    fun `combined2 combines two signals`() {
        ...
        val combined = _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal2(a, b) { x, y -> x + y }
    ...
    fun `combined3 combines three signals`() {
        ...
        val combined = _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal3(a, b, c) { x, y, z -> x + y + z }
    ...
    fun `combined4 combines four signals`() {
        ...
        val combined =
            _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal4(a, b, c, d) { w, x, y, z -> w + x + y + z }
    ...
    fun `combined5 combines five signals`() {
        ...
        val combined = _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal5(
            a,
            b,
            c,
            d,
    ...
    fun `combined6 combines six signals`() {
        ...
        val combined = _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal6(
            a,
            b,
            c,
            d,
    ...
    fun `combined signals can have different types`() {
        val name = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("John")
        val age = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(30)
        val combined =
            _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal2(name, age) { n, a -> "$n is $a years old" }
    ...
    fun `combined signals can produce complex types`() {
        ...
        val age = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(30)
        val combined =
            _root_ide_package_.io.github.fenrur.signal.impl.CombinedSignal2(name, age) { n, a -> Person(n, a) }
