...
class DefaultBindableSignalTest : io.github.fenrur.signal.AbstractSignalTest<io.github.fenrur.signal.Signal<Int>>() {
    ...
    override fun createSignal(initial: Int): io.github.fenrur.signal.Signal<Int> {
        val source = _root_ide_package_.io.github.fenrur.signal.signalOf(initial)
        return _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal(source)
    }
    ...
    class BindableBehaviorTests : io.github.fenrur.signal.AbstractBindableSignalTest<io.github.fenrur.signal.BindableSignal<Int>>() {
        ...
        override fun createUnboundSignal(): io.github.fenrur.signal.BindableSignal<Int> =
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal()

        override fun createSignal(source: io.github.fenrur.signal.Signal<Int>): io.github.fenrur.signal.BindableSignal<Int> =
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal(source)
        ...
        override fun createSignal(source: io.github.fenrur.signal.Signal<Int>, takeOwnership: Boolean): io.github.fenrur.signal.BindableSignal<Int> =
            _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal(source, takeOwnership)
    ...
    fun `can bind to read-only signal`() {
        val readOnly = _root_ide_package_.io.github.fenrur.signal.signalOf(42)
        val signal = _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal(readOnly)
    ...
    fun `bindable signal reflects source value without write capability`() {
        ...
        val signal = _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal(source)
    ...
    fun `toString shows value and state`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal(
            _root_ide_package_.io.github.fenrur.signal.signalOf(42)
        )
    ...
    fun `toString shows not bound when unbound`() {
        val signal = _root_ide_package_.io.github.fenrur.signal.impl.DefaultBindableSignal<Int>()
