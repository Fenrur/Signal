...
class PairwiseSignalTest {
    ...
    fun `pairwise with string values`() {
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal("a")
        val pairwise = source.pairwise()
    ...
    fun `pairwise with complex objects`() {
        ...
        val source = _root_ide_package_.io.github.fenrur.signal.impl.DefaultMutableSignal(Point(0, 0))
        val pairwise = source.pairwise()
