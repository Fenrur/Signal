...
/**
 * Default implementation of [io.github.fenrur.signal.BindableSignal] with glitch-free semantics.
 *
...
class DefaultBindableSignal<T>(
    ...
    private fun bindToInternal(newSignal: io.github.fenrur.signal.Signal<T>, notifyListeners: Boolean) {
        ...
        if (_root_ide_package_.io.github.fenrur.signal.BindableSignal.wouldCreateCycle(this, newSignal)) {
